  ...
  return (
    ...
    <div style={{ position: "fixed", inset: 0, background: "#05050a", display: "flex", flexDirection: "column" }}>
      <div style={{ position: "relative", flex: 1, minHeight: 0 }}>
        <SkyView params={view.params} sunPosition={view.sun} starOpacity={view.stars} model={model} albedo={albedo} disc={disc} discDeg={discDeg} facing={facing} hour={hour} saturation={saturation + (SKY_GRADE.saturationUnderSmoke - saturation) * smokeRegime(pmAbs)} particles={smoke} style={{ width: "100%", height: "100%" }} live />
