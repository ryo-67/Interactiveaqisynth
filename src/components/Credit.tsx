// Credit — the footer's credit (Shoro, 2026-09-16): "Made by Shoro Roy" as one button-shaped link, the same pill, type and behaviour as the Patch notes button beside it (the play button's hover fill covers the whole pill), with Lucide's pencil-sparkles before the words. The whole line was one link already, so the pill is the link. Sits at the bottom bar's right end on laptop and beside the Patch notes button, centred, below that (index.css .scene-bottom).
