...
export const AQI_CATEGORIES = [
  ...
  { max: 300, dark: "#bd6bff", light: "#c2a0ff" }, // violet, 0.29 → 0.44 (2026-09-16: the 3:1 light end was a lavender that read as faded pink against orange and haze; the light end keeps its blue and clears 2.7:1 on the brightest panel, Shoro's call, like the magenta above it)
