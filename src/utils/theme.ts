...
export const AQI_CATEGORIES = [
  ...
  { max: 300, dark: "#8f80ff", light: "#b0a4ff" }, // blue-violet, hue 248°, 0.28 → 0.43 (2026-09-16: at 270° the violet read as faded pink against orange and haze; a bluer hue stays a purple on every panel, Shoro's call, its light end at 2.7:1 on the brightest panel like the magenta above it, its dark end at 3:1)
