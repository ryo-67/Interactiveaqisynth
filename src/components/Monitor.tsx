...
import type { ChannelSuffix } from "../utils/channelSource";
...
interface Props {
  ...
  suffixes?: ChannelSuffix; // a word beside a borrowed channel on the source pills (D-56)
}
...
export function Monitor({ m, pulse, lifts, setRef, routing, suffixes }: Props) {
  ...
  return (
    <div className="scene-monitor" data-routing={routing}>
      ...
      <Card label={MONITOR_LABELS.scale} sources={["pm25"]} suffixes={suffixes} className="scene-card-scale" cardRef={setRef("scale")}>
      ...
      <Card label={MONITOR_LABELS.tone} sources={["pm25", "no2"]} suffixes={suffixes} className="scene-card-tone" cardRef={setRef("tone")}>
        <Value>{tone}</Value>
      ...
      <Card label={MONITOR_LABELS.beats} sources={["no2"]} suffixes={suffixes} className="scene-card-beats">
      ...
      <Card label={MONITOR_LABELS.brightness} sources={["o3"]} suffixes={suffixes} className="scene-card-brightness">
      ...
      <Card label={MONITOR_LABELS.reverb} sources={["pm25"]} suffixes={suffixes} className="scene-card-reverb">
