...
1. Hero: two cards in the monitor's style (2026-09-16), across the section. The AQI card, at its content width, holds the number under the label "AQI · now" on Live or "AQI · Oct 29" on an archive day, the number being the current AQI or the day's official AQI (D-42). The Breath card takes the rest: the mood word coloured by its AQI on the EPA ramp over the tier's sentence, always two lines, the word following the graph's AQI line at the hour being heard. Below laptop the pair is exactly as tall as the monitor's first row. No clause placeholders and no beat pulse (2026-09-15).
