...
| GRA-02 | P1 | TODO | A real visualization for the pulse row | The 16-step marks with per-bar hit counts are legible but carry no metaphor. Shoro: what the pulse should look like |
